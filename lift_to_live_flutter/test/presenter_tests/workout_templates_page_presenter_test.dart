...
void main() {
  ...
  test('test fetchData() success', () async {
    ...
    when(exerciseRepo.getExercises()).thenAnswer((realInvocation) async => [Exercise('bodypart1', 'equipment1', 'gifUrl1', 'name1', 'muscleGroup1'), Exercise('bodypart2', 'equipment2', 'gifUrl2', 'name2', 'muscleGroup2'), Exercise('bodypart3', 'equipment3', 'gifUrl3', 'name3', 'muscleGroup3'), ]);
    when(workoutRepo.fetchTemplates(any, any)).thenAnswer((realInvocation) async => [TestData.testWorkoutTemplate1, TestData.testWorkoutTemplate2]);
    ...
    expect(element0.name, TestData.testWorkoutTemplate2.name);
    expect(element1.name, TestData.testWorkoutTemplate1.name);

    expect(element0.creationDate, TestData.testWorkoutTemplate2.createdOn);
    expect(element1.creationDate, TestData.testWorkoutTemplate1.createdOn);
  });
