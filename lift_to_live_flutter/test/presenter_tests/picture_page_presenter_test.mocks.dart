...
// in lift_to_live_flutter/test/presenter_tests/picture_page_presenter_test.dart.
...
/// A class which mocks [PicturePageView].
///
/// See the documentation for Mockito's code generation for more information.
class MockPicturePageView extends _i1.Mock implements _i7.PicturePageView {
  MockPicturePageView() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  void setPictures(
    List<_i8.Widget>? pictureSide,
    List<_i8.Widget>? pictureFront,
    List<_i8.Widget>? pictureBack,
  ) =>
      super.noSuchMethod(
        Invocation.method(
          #setPictures,
