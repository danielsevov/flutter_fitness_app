...
// in lift_to_live_flutter/test/presenter_tests/edit_habits_page_presenter_test.dart.
...
/// A class which mocks [EditHabitsPageView].
///
/// See the documentation for Mockito's code generation for more information.
class MockEditHabitsPageView extends _i1.Mock
    implements _i6.EditHabitsPageView {
  MockEditHabitsPageView() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  List<_i7.TextEditingController> getControllers() => (super.noSuchMethod(
        Invocation.method(
          #getControllers,
          [],
        ),
        returnValue: <_i7.TextEditingController>[],
      ) as List<_i7.TextEditingController>);
  @override
  void notifySavedChanges() => super.noSuchMethod(
        Invocation.method(
          #notifySavedChanges,
          [],
        ),
