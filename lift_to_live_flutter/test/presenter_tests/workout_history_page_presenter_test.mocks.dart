...
// in lift_to_live_flutter/test/presenter_tests/workout_history_page_presenter_test.dart.
...
/// A class which mocks [WorkoutHistoryPageView].
///
/// See the documentation for Mockito's code generation for more information.
class MockWorkoutHistoryPageView extends _i1.Mock
    implements _i8.WorkoutHistoryPageView {
  MockWorkoutHistoryPageView() {
    _i1.throwOnMissingStub(this);
  }

  @override
  void setWorkoutData(
    List<_i9.Widget>? list,
  ...
  @override
  void notifyNoWorkoutsFound() => super.noSuchMethod(
        Invocation.method(
          #notifyNoWorkoutsFound,
          [],
        ),
        returnValueForMissingStub: null,
      );
