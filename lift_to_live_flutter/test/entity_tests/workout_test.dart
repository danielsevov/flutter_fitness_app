...
void main() {
  test('Workout constructor test', () {
    final workoutSet = MockData.testWorkout1;
  ...
  group('Workout fromJson tests', (){
    ...
    test('Workout fromJson compared to other Workout', () {
      final workoutSet = MockData.testWorkout1;
      final workoutSet2 = MockData.testWorkout2;
  ...
  group('Workout equals tests', (){
    ...
    test('Workout equals compared to self 2', () {
      final Workout workoutSet = MockData.testWorkout1;
      final workoutSet2 = Workout(1, 'A', 'A', 'A', 'A', false, 'A', 'A', 'A', [MockData.testWorkoutSet1]);
