...
void main() {
  test('Habit constructor test', () {
    final habit = TestData.testHabit1;

    expect(habit.userId, 'A');
    expect(habit.id, 1);
    expect(habit.date, 'A');
    expect(habit.habits, [TestData.testHabitTask1, TestData.testHabitTask2, TestData.testHabitTask3]);
  ...
  group('Habit toJson tests', (){
    ...
    test('Habit toJson compared to other', () {
      final habit = TestData.testHabit1;
      final habit2 = TestData.testHabit2;
  ...
  group('Habit equals tests', (){
    ...
    test('Habit equals compared to self 2', () {
      final Habit habit = TestData.testHabit1;
      final habit2 = Habit(1, 'A', 'A', 'A', 'A', false, TestData.testListTasks1);
  ...
  group('Habit hashCode tests', (){
    ...
    test('Habit hashCode compared to other Habit', () {
      final habit = TestData.testHabit1;
      final habit2 = TestData.testUser1;
