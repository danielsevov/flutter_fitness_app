...
import 'package:lift_to_live_flutter/presentation/ui/widgets/forms_and_dialogs/custom_form_dropdown_text_field.dart';
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            /// name text field
            CustomFormTextField(screenHeight: widget.screenHeight, screenWidth: widget.screenWidth, controller: widget._nameController, textInputType: TextInputType.text, hint: 'Enter user name', icon: Icons.person, obscureText: false, validator: (value) {
            ...
            /// email text field
            CustomFormTextField(screenHeight: widget.screenHeight, screenWidth: widget.screenWidth, controller: widget._emailController, textInputType: TextInputType.emailAddress, hint: 'Enter user email address', icon: Icons.email_outlined, obscureText: false, validator: (value) {
              if (value == null ||
            ...
            /// password text field
            CustomFormTextField(screenHeight: widget.screenHeight, screenWidth: widget.screenWidth, controller: widget._passwordController, textInputType: TextInputType.text, hint: 'Enter user password', icon: Icons.key, obscureText: true, validator: (value) {
            ...
            CustomFormTextField(screenHeight: widget.screenHeight, screenWidth: widget.screenWidth, controller: widget._nationalityController, textInputType: TextInputType.text, hint: 'Enter user nationality', icon: Icons.location_pin, obscureText: false, validator: (value) {
              if (value == null || value.length < 2) {
            ...
            /// phone text field
            CustomFormTextField(screenHeight: widget.screenHeight, screenWidth: widget.screenWidth, controller: widget._phoneController, textInputType: TextInputType.phone, hint: 'Enter user phone number', icon: Icons.phone, obscureText: false, validator: (value) {
            ...
            CustomFormTextField(screenHeight: widget.screenHeight, screenWidth: widget.screenWidth, controller: widget._dateController, textInputType: TextInputType.datetime, hint: 'Enter user birth date', icon: Icons.date_range, obscureText: false, validator: (value) {
            ...
            /// coach text field
            CustomFormDropdownTextField(screenHeight: widget.screenHeight, screenWidth: widget.screenWidth, controller: widget._coachController, textInputType: TextInputType.text, hint: 'Enter coach ID', icon: Icons.fitness_center, obscureText: false, onChanged: (newValue) {
            ...
            /// submit form button
            CustomFormButton(screenHeight: widget.screenHeight, screenWidth: widget.screenWidth, title: 'Register User', icon: Icons.check, function: () {
