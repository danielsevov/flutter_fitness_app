...
class CalendarWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: habits.isNotEmpty ? TableCalendar(
          ...
          headerStyle: const HeaderStyle(
            ...
            leftChevronIcon: Icon(Icons.arrow_circle_left, color: Helper.yellowColor,),
            rightChevronIcon: Icon(Icons.arrow_circle_right, color: Helper.yellowColor,),
            titleCentered: true,
            formatButtonVisible: false,
          ),
          daysOfWeekStyle: const DaysOfWeekStyle(weekdayStyle: TextStyle(color: Helper.whiteColor), weekendStyle: TextStyle(color: Colors.grey)),
          ...
          lastDay: DateTime.now()) : const SizedBox(),
    );
  }
}